...
```sh
  cd my-folder
  git clone https://github.com/Kaghenimbale/hello-rails-react
```
...
Feel free to check the [issues page](https://github.com/Kaghenimbale/hello-rails-react/issues).
...
This project is [MIT](https://github.com/Kaghenimbale/hello-rails-react/blob/dev/LICENSE) licensed.
